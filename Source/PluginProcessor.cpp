...
bool SoundCollectorAudioProcessor::acceptsMidi() const
{
...
bool SoundCollectorAudioProcessor::producesMidi() const
{
...
bool SoundCollectorAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double SoundCollectorAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int SoundCollectorAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int SoundCollectorAudioProcessor::getCurrentProgram()
{
    return 0;
}

void SoundCollectorAudioProcessor::setCurrentProgram (int index)
{
}
...
void SoundCollectorAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
