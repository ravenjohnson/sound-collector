...
public:
    ...
    {
        dailyOverwrite,  // Default: overwrite same day, new file each day
        rollingN         // Future: keep last N autosaves (stub for now)
    };
    void setAutoSaveMode(AutoSaveMode mode) { autoSaveMode = mode; }
